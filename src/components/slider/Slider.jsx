...
import BlueChip from "../../assets/images/slider/PurpleGoat2.png";
              ...
              <div className="wrap-heading flat-slider flex">
                <div className="content">
                  ...
                  <h1 className="heading mb-style">
                    <span className="tf-text s1">Prime Goat</span>
                  </h1>
                  <h1 className="heading">Coming Soon!</h1>
                  <p className="sub-heading">
                    A collection of 5,555 NFTs in the Ethereum Blockchain
                  </p>
