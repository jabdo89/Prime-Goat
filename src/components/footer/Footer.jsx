            ...
            <div className="col-lg-3 col-md-12 col-12">
              <div className="widget widget-logo">
                ...
                <p className="sub-widget-logo">
                  You can buy from our official website in pre-sale or
                  public-sale an “unrevealed” PrimeGoat or in the secondary
                  market place opensea.io (use the discord official links) Be
                  aware of scammers, we will never DM you.
                </p>
              </div>
            </div>
            <div className="col-lg-2 col-md-4 col-sm-5 col-5">
              <div className="widget widget-menu style-1">
                <h5 className="title-widget">Home</h5>
                <ul>
